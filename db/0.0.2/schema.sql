...
--
-- Name: fk_parts__creator_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY parts
    ADD CONSTRAINT fk_parts__creator_id FOREIGN KEY (creator_id) REFERENCES users(user_id);
